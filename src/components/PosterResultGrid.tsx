...
interface PosterResultGridProps {
  /** Every result carries its own side of TMDB (films and shows can mix). */
  results: (TmdbResult & { mediaType: 'movie' | 'tv' })[]
...
export function PosterResultGrid({ results, onOpenTitle }: PosterResultGridProps) {
  return (
