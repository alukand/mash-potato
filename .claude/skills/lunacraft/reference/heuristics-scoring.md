...
- Contextual help when needed (tooltips; NOT inline hint/footnote text, which the user has banned: see copy-doctrine.md § No footnote microcopy)
...
- Contextual help (tooltips, guided tours; NOT inline hint/footnote text: user-banned, see copy-doctrine.md § No footnote microcopy)
