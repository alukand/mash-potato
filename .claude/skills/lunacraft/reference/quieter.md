...
**Not for:** wrong topology, broken grids, missing hierarchy, photo illegibility, overlay display type, or duplicate section bands — use [layout.md](layout.md), [distill.md](distill.md), and [typeset.md](typeset.md) per [composition-guardrails.md](composition-guardrails.md).

**For:** correct structure that feels loud, hot, or busy (saturation, grain, glow, motion noise, competing accents after weight budget is applied).
...
When the result feels right, this pass is complete. The calling workflow determines the next step.
