...
If the project `CLAUDE.md` or legacy `.cursorrules` contains a `## Design Context` section (generated by `/lunacraft teach` or project-context initialization), derive 1–2 additional personas from the audience and brand information:
